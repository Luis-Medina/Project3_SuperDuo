...
{
    public static final String ADDED_RESULTS = "addedResults";
    ...
    {
        Log.e("FETCHSERVICE", "Getting data");
        getData("n2");
        getData("p2");

        // Send command to refresh widget
        sendBroadcast(ScoresAppWidgetProvider.getRefreshBroadcastIntent(this));
    ...
    private void getData (String timeFrame)
    {
        ...
        try {
            if (JSON_data != null) {
                Log.e("JSON", "JSON result for timeframe " + timeFrame + ": " + JSON_data);
